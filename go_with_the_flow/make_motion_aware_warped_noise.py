...
def parse_arguments():
    ...
    parser.add_argument("--min_scale", type=float, default=0.95)
    parser.add_argument("--max_scale", type=float, default=1.01)
    parser.add_argument("--low_percentile", type=float, default=3.0)
    parser.add_argument("--high_percentile", type=float, default=0.0)
